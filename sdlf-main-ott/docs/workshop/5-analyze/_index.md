...
## 5.2 Trending Lambda — week-over-week growth
...
## 5.3 Content Gap Lambda — 5 daily reports + HTML dashboard
...
## 5.5 HTTP API — read the trending data programmatically
...
## 5.6 Browse the 5 Content-Gap reports via API
...
**Next**: [chapter 6 — Verify](../6-verify/).
