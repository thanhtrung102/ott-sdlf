...
## 2.2 IAM principal with Lake Formation admin

The deploying principal must be a Lake Formation administrator. Without this, the `IAM_ALLOWED_PRINCIPALS` revoke step in chapter 3 will silently no-op and your column-level RBAC won't activate.
...
## 2.3 Amazon Bedrock — Claude Haiku enabled
...
## 2.5 The genre-classifier zip in the artifacts bucket
...
## 2.7 Source data — 14 days of OTT Parquet
...
When all seven check, proceed to [chapter 3 — Deploy](../3-deploy/).
