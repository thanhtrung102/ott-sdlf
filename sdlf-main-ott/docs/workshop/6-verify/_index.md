...
## 6.1 The contract test (16 assertions)
...
## 6.2 Live data visuals (`scripts/audit_visuals.py`)
...
## 6.4 CloudWatch dashboard + alarms
...
## 6.5 Live API hit with the freshness header
